    ...
    <div class="container-fluid">
        <div class="block-header">
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12">
                    <h1 class="h3 mb-0 text-gray-800">এফ ডি আর  ফর্ম </h1>
                </div>
                <div class="col-lg-5 col-md-6 col-sm-12">
                    <ul class="breadcrumb float-md-right">
                        <li class="breadcrumb-item"><a href="#"><i class="zmdi zmdi-home"></i> {{\App\Setting::setting()->app_name}}</a></li>
                        <li class="breadcrumb-item active">এফ ডি আর  ফর্ম </li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-12">
            <div class="card shadow">
                ...
                <div class="body">
                    <form method="POST" action="{{route('FDRApplicationSubmit')}}">
                        {{csrf_field()}}
                        <div class="row clearfix">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="user_id" id="user_id" onchange="getUser(this.value)" class="form-control z-index show-tick selectpicker"  data-live-search="true">
                                        ...
                                        @foreach($members??array() as $member)
                                            <option value="{{$member->id}}">{{$member->name_bn}} - {{$member->unique_id}} </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="profit_type" id="profit_type" class="form-control z-index show-tick selectpicker"  data-live-search="true">
                                        <option value="">বাছাই করুন</option>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="সময়কাল " name="duration" value="{{old('duration')}}" id="amount">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <label for=""><small> এফ ডি আর আইডি (ফাকা রাখলে স্বয়ংক্রিয় ভাবে তৈরি হবে)</small></label>

                                    <input type="text" class="form-control" placeholder="এফ ডি আর আইডি " name="fdr_unique_id" value="{{old('fdr_unique_id')}}" id="fdr_unique_id">
