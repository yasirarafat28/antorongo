                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h6 mb-0 font-weight-bold text-gray-800">  ৳ {{App\NumberConverter::en2bn($closed_target_amount,2)}} টাকা</div>
                                <span style="font-size: 15px;">মোট লাভ</span>
                                <div class="h6 mb-0 font-weight-bold text-gray-800">৳ {{App\NumberConverter::en2bn($closed_total_profit_paid + $closed_total_revenue_paid,2)}} টাকা</div>
                                <span style="font-size: 15px;">মোট ফেরত </span>
                                <div class="h6 mb-0 font-weight-bold text-gray-800">৳ {{App\NumberConverter::en2bn($closed_target_amount + $closed_total_profit_paid + $closed_target_amount,2)}} টাকা</div>
                            @endif
                                ...
                                <div class="col-lg-3 col-md-3">
                                    ...
                                    <div class="input-group">
                                        <select name="status" id="" class="form-control">
                                            ...
                                            <option {{isset($_GET['status']) && $_GET['status']=='approved'?'selected':'' }} value="approved">সক্রিয় সঞ্চয়</option>
