    ...
    <div class="container-fluid">
        ...
        <div class="col-md-12">
            <div class="card shadow">
                ...
                <div class="body">
                    <form method="POST" action="{{route('SavingApplication')}}">
                        {{csrf_field()}}
                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-lg-8 col-md-8 col-sm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="package_id" id="identified_id" class="form-control ms"  data-live-search="true">
                                        <option value="">বাছাই করুন</option>
                                        @foreach($packages??array() as $item)
                                            <option value="{{$item->id}}">{{$item->name}} | জমার পরিমান : {{\App\NumberConverter::en2bn($item->installment_amount)}}| মোট জমা : {{\App\NumberConverter::en2bn($item->target_amount)}} | মোট ফেরত : {{\App\NumberConverter::en2bn($item->return_amount)}}  - {{$item->type=='long'?'দীর্ঘ মেয়াদী':'সল্প মেয়াদী'}} </option>
                                        @endforeach
                                    </select>
