                ...
                <div class="card shadow">
                    ...
                    <div class="col-md-12 row mb-3">
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-12">
                            ...
                            <div class="mt-5 profile-image float-md-right"> <img src="{{url($saving->user->photo??'')}}" onerror="this.onerror=null;this.src='{{asset('/front/images/no_img_avaliable.jpg')}}';"> </div>
