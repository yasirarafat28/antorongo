...
<section class="content">
    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">পরিষেবা এর তালিকা</h1>

            <ul class="breadcrumb float-md-right">
                <li class="breadcrumb-item"><a href="#"><i class="zmdi zmdi-home"></i> {{\App\Setting::setting()->app_name}}</a></li>
                <li class="breadcrumb-item"><a href="javascript:void(0);">পরিষেবা এর তালিকা</a></li>
            </ul>
        </div>
                    ...
                    <div class="header">
                        <div class="clearfix">
                            <div class="float-left">
                                <h2>পরিষেবা এর তালিকা</h2>
                            </div>
                            <div class="float-right">
                                <a href="/admin/services/create" class="btn btn-primary"> <i class="fas fa-fw fa-plus"></i> পরিষেবা যোগ করুন </a>
                            </div>
                        </div>
                            ...
                            @foreach($records as $item)
                                <tr>
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in"
                                        ...
                                        <a  data-toggle="modal" data-target="#servicEidtModal{{$item->id}}" class="dropdown-item"><i class="fa fa-edit"> </i> এডিট </i></a>
                                        <a  data-toggle="modal" data-target="#servicShowModal{{$item->id}}" class="dropdown-item"><i class="fa fa-eye"> </i> বিস্তারিত </i></a>
    ...
    <!-- Edit Modal Start -->
    <div class="modal fade" id="servicEidtModal{{$row->id}}" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">

                        <div class="modal-header">
                            <h2><strong> পরিষেবা</strong> এডিট</h2>
    ...
    <!-- Show Modal Start -->
    <div class="modal fade" id="servicShowModal{{$row->id}}" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">


                        <div class="modal-header">
                            <h2><strong> পরিষেবা</strong> বিস্তারিত</h2>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
