			...
			<div class="row">
				...
				<div class="col-lg-8">
					<div class="blog_content">
						<div class="blog_title">{{$row->title??'N/A'}}</div>
						<div class="blog_meta">
							<ul>
						...
						<div class="blog_image"><img src="{{url($row->feature_image??'')}}" alt="photo" onerror="this.src='/front/images/no_img_avaliable.jpg';"></div>
